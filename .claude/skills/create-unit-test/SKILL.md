...
description: Generate comprehensive unit tests for provided code or description. Use when the user wants to create tests for a function, class, or module with proper coverage of edge cases, boundary conditions, and error handling.
---
